...
/*		StringBuffer sql=new StringBuffer("insert into wml_user ( ");
		if(item!=null){
		...
		if(item!=null){
			...
			if(item.getUid()!=null){
				sql.append("\"" + item.getUid()+"\",");
			}
			if(item.getLoginName()!=null){
				sql.append("\"" + item.getLoginName()+"\",");
			}			
			if(item.getPassword()!=null){
				sql.append("\"" + item.getPassword()+"\",");
			}
			if(item.getUid()!=null){
				sql.append("\"" + item.getUid()+"\",");
			}
			if(item.getHead()!=null){
				sql.append("\"" + item.getHead()+"\",");
			}
			if(item.getSignature()!=null){
				sql.append("\"" + item.getSignature()+"\",");
			}
			if(item.getPhone()!=null){
				sql.append("\"" + item.getPhone()+"\",");
			}
			if(item.getType()!=null){
				sql.append("\"" + item.getType()+"\",");
			}
			if(item.getOrgan()!=null){
				sql.append("\"" + item.getOrgan()+"\",");
			}
			if(item.getPermissions()!=null){
				sql.append("\"" + item.getPermissions()+"\",");
			}
			if(item.getChannel()!=null){
				sql.append("\"" + item.getChannel()+"\",");
			}
			if(item.getUploadFlag()!=null){
				sql.append("\"" + item.getUploadFlag()+"\",");
			}
			if(item.getStatus()!=null){
				sql.append("\"" + item.getStatus()+"\",");
			}
			sql.append("\"" + TimeUtil	.getCurrentTime("yyyy-MM-dd HH:mm:ss")+"\",");
			sql.append("\"" + TimeUtil	.getCurrentTime("yyyy-MM-dd HH:mm:ss")+"\",");
